...
public class EmpMain {
	...
	public static void main(String[] args) {
		...
		/*
		 * System.out.println("=== 신규사원 등록 ==="); EmpVO emp = new EmpVO();
		 * 
		 * emp.setEmployeeId(500); emp.setFirstName("FIRST_NAME");
		 * emp.setLastName("LAST_NAME"); emp.setEmail("EMAIL");
		 * emp.setPhoneNumber("PHONE_NUMBER"); emp.setJobId("IT_PROG");
		 * emp.setSalary(8000); emp.setCommissionPct(0.2); emp.setManagerId(100);
		 * emp.setDepartmentId(10);
		 * 
		 * try { empService.insertEmp(emp); System.out.println("insert ok"); }
		...
		System.out.println("=== 500 사원의 급여를 10% 인상 ===");
