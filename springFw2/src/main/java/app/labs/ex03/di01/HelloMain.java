...
public class HelloMain {
	...
	public static void main(String[] args) {
		...
		// 6) Setter
		HelloController controller2 
			= context.getBean("helloController2", HelloController.class);
		controller2.hello("홍길동");
		
		HelloController controller3 
			= context.getBean("helloController3", HelloController.class);
